...
export default function Radar({
  ...
  useEffect(() => {
    ...
    resize();
    // El contenedor puede empezar dentro de una pantalla con display:none
    // (aún no visible), donde offsetWidth/Height son 0. Un ResizeObserver,
    // a diferencia de window "resize", sí detecta cuando pasa a visible.
  ...
  return <div ref={containerRef} className="radar-fx-container" />;
}
